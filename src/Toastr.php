...
class Toastr
{
    ...
    {
        return '<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/clayi/toastr@' . $version . '/dist/css/clayi-toastr.min.css">';
    }
    ...
    {
        return '<script src="https://cdn.jsdelivr.net/gh/clayi/toastr@' . $version . '/dist/js/clayi-toastr.min.js"></script>';
    }
