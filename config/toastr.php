...
return [
    ...
    'options' => [
        ...
        'closeButtonIcon' => 'clayi-toast-close-icon',
        ...
        'positionClass' => 'clayi-toast-top-right',
        ...
        'icons' => [
            'info' => 'clayi-toast-info-icon',
            'warning' => 'clayi-toast-warning-icon',
            'success' => 'clayi-toast-success-icon',
            'error' => 'clayi-toast-error-icon',
        ],
        ...
        'colorsClasses' => [
            'info' => 'clayi-toast-info',
            'warning' => 'clayi-toast-warning',
            'success' => 'clayi-toast-success',
            'error' => 'clayi-toast-error',
        ],
    ],
